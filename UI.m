...
% Last Modified by GUIDE v2.5 04-May-2015 03:14:45
...
if ~isempty(bData)
    ...
    if ~isempty(idxB)
        ...
        I = insertShape(I, 'Polygon', bboxPolygon, 'Color', 'green', 'LineWidth', 3);
    end
end
